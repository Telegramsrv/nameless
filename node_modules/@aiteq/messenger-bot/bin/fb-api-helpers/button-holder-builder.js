...
class ButtonHolderBuilder extends builder_1.Builder {
    addCallButton(title, payload) {
        this.addButton({
    ...
    addExtensionButton(title, extension, options) {
        const button = {
            type: fb_api_1.Send.ButtonType.WEB_URL,
            title,
            url: "EXTENSION/" + extension.getView()
        };
        if (options) {
...
exports.ButtonHolderBuilder = ButtonHolderBuilder;
